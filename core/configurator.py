...
**Использование:**
 [▪️](emoji/5251481573953405172) `{prefix}config prefix` `<новый префикс>` - __Изменить префикс команд__
 [▪️](emoji/5251481573953405172) `{prefix}config autoclean` `<on/off>` - __Включить/выключить автоклинер__
 [▪️](emoji/5251481573953405172) `{prefix}config autoclean_delay` <секунды>` - __Установить задержку автоклинера__
 [▪️](emoji/5251481573953405172) `{prefix}config autostart` `<on/off>` - __Включить/выключить автозапуск__
 [▪️](emoji/5251481573953405172) `{prefix}config font` `<название_шрифта>` - __Установить шрифт__
 [▪️](emoji/5251481573953405172) `{prefix}config font_enable` `<on/off>` - __Включить/выключить шрифты__
 [▪️](emoji/5251481573953405172) `{prefix}config status` - __Показать текущие настройки__
